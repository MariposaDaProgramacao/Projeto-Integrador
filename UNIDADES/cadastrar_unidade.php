<?php
// ============================================================
// ARQUIVO: UNIDADES/cadastrar_unidade.php (MODIFICADO PARA MULTI-TENANT)
// ============================================================
...
// Apenas administradores podem cadastrar unidades
$tipos_permitidos = ['admin_cliente'];
if (!in_array($_SESSION['tipo_usuario'] ?? '', $tipos_permitidos)) {
    setMessage('error', 'Acesso negado. Apenas administradores podem cadastrar unidades.');
...
$titulo = 'Cadastrar Unidade - Gerenciador de Salas';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
<body>
    ...
    <main class="main">
        <header class="page-header">
            <div>
                <h1 class="page-title"><i class="fas fa-plus-circle"></i> Cadastrar Unidade</h1>
                <p class="page-subtitle">Preencha os dados para cadastrar uma nova unidade</p>
            </div>
        ...
        <div class="card-panel">
            <form action="processar_unidades.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nome" id="nome" placeholder="Ex: Unidade Centro" required>
                </div>

                <div class="form-row">
                    <div class="form-group">
                        <label for="estado">UF <span class="required">*</span></label>
                        <input type="text" name="estado" id="estado" maxlength="2" placeholder="Ex: SP" required>
                    </div>
                    <div class="form-group">
                        <label for="cidade">Cidade <span class="required">*</span></label>
                        <input type="text" name="cidade" id="cidade" placeholder="Ex: São Paulo" required>
                    </div>
                </div>

                <div class="form-group">
                    <label for="endereco">Endereço <span class="required">*</span></label>
                    <input type="text" name="endereco" id="endereco" placeholder="Ex: Rua Augusta, 1000" required>
                </div>

                <div class="form-row">
                    <div class="form-group">
                        <label for="telefone">Telefone</label>
                        <input type="text" name="telefone" id="telefone" placeholder="(31) 3333-3333">
                    </div>
                    <div class="form-group">
                        <label for="email">E-mail</label>
                        <input type="email" name="email" id="email" placeholder="unidade@senac.br">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="fuso" id="fuso" class="select-dropdown" required>
                        ...
                        <?php foreach ($fusos as $valor => $label): ?>
                            <option value="<?php echo $valor; ?>" <?php echo ($valor === 'America/Sao_Paulo') ? 'selected' : ''; ?>>
                                <?php echo $label; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
